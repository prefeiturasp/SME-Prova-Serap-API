...
namespace SME.SERAp.Prova.Dominio
{
    ...
    {
        public DownloadProvaAluno(long provaId, long alunoRa, string dispositivoId, TipoDispositivo tipoDispositivo, string modeloDispositivo, string versao, int situacao)
        {
            AlunoRA = alunoRa;
            ProvaId = provaId;
