...
namespace SME.Background.Hangfire
{
    public class Worker : IWorker
    {
        ...
        public Worker(IConfiguration configuration, IServiceCollection serviceCollection, string connectionString)
        {
            ...
            this.connectionString = (!connectionString.EndsWith(';') ? connectionString + ";" : connectionString) + "Application Name=SERAp Worker Service";
        }
        ...
        private void RegistrarHangfireServer()
        {
            ...
            Console.WriteLine($"SERAp Worker Service - BackgroundWorkerQueuePollInterval parameter = {pollInterval}");
