...
namespace SME.SERAp.Prova.Dados
{
    public interface IRepositorioProva : IRepositorioBase<Dominio.Prova>
    {
        ...
        Task<IEnumerable<ProvaDetalheCompletoBaseDadosDto>> ObterDetalhesCompletoPorIdAsync(long provaId);
        Task<IEnumerable<ProvaDetalheCompletoBaseDadosDto>> ObterDetalhesCompletoBIBPorIdERaAsync(long provaId, long alunoRA);
    }
}
