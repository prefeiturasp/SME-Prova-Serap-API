...
Funcionalidade: Web - Tela inicial (Home) do SERAp
  ...
  Quero visualizar a tela inicial
  Para acessar as informações e atalhos do sistema
  ...
  Cenário: Exibir seção de páginas em destaque
    Então devo visualizar a seção de páginas em destaque
